...
def evaluate_all(dataset, all_boxes, output_dir, test_corloc=False, all_cls_scores=[], use_matlab=False):
    """Evaluate "all" tasks, where "all" includes box detection, instance
    segmentation, and keypoint detection.
    """
    all_results = evaluate_boxes(dataset, all_boxes, output_dir, all_cls_scores, test_corloc=test_corloc, use_matlab=use_matlab)
    return all_results


def evaluate_boxes(dataset, all_boxes, output_dir, all_cls_scores, test_corloc=False, use_matlab=False):
    ...
    if _use_voc_evaluator(dataset):
        ...
        voc_eval = voc_dataset_evaluator.evaluate_boxes(dataset, all_boxes, output_dir, all_cls_scores, test_corloc=test_corloc, use_matlab=use_matlab)
